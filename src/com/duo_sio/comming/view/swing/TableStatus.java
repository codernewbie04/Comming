...
public class TableStatus extends JLabel {
    ...
    public void setType2(CashType type){
        this.type2 = type;
        setText(type.toString());
        repaint();
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        if (type != null) {
            ...
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            GradientPaint g;
            if(type2 == CashType.IN){
                g = new GradientPaint(0, 0, new Color(87, 219, 72), 0, getHeight(), new Color(87, 219, 72));
            } else {
                g = new GradientPaint(0, 0, new Color(237, 55, 52), 0, getHeight(), new Color(237, 55, 52));
            }
            g2.setPaint(g);
            g2.fillRoundRect(0, 0, getWidth(), getHeight(), 1, 1);
        }
